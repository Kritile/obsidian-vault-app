...
void main() {
  final base = Uri.parse('https://cloud.example.com/remote.php/dav/files/pavel/vault/');
  ...
  test('normalizes a user-entered URL with a literal percent', () {
    expect(
      WebDavPathCodec.parseBaseUrl('https://cloud.example.com/My 2.5% vault')?.toString(),
