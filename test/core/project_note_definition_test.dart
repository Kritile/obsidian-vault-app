...
void main() {
  final templatesAvailable = Directory('../Templates/Projects').existsSync();
  test(
    'all native project note types match Obsidian templates',
    () {
    ...
    skip: templatesAvailable
        ? false
        : 'Внешний Obsidian vault с Templates/Projects не подключён',
  );
}
